...
namespace Diet_DAL.Repositories
{
    public class NutrientInfoRepository
    {
        ...
        public List<NutrientInfo> GetAllNutrientInfos()
        {
        ...
        public List<NutrientInfo> GetByNutrienIdTurnList(int nutrientId)
        {
            return dbContext.NutrientInfos.Where(a => a.NutrientID == nutrientId).ToList();

        }

        public NutrientInfo GetByNutrientInfoId(int nutrientInfoId)
        {
            return dbContext.NutrientInfos.Where(a => a.ID == nutrientInfoId).FirstOrDefault();
        }
