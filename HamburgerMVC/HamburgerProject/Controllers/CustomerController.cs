    ...
    public class CustomerController : Controller
    {
        ...
        */
        ...
        public async Task<IActionResult> OrderAdd(AddOrderVM orderList)
        {
            ...
            Order order = orderRepository.GetAllMenuAndExtras(orderList.OrderId);
            orderList.Order = order;
            var menu = menuGenericRepository.GetById(orderList.MenuId);
            var extra = extraGenericRepository.GetById(orderList.ExtraId);
            extra.Quantity = orderList.ExtraQuantity;
            menu.Quantity = orderList.MenuQuantity;
            extraGenericRepository.Update(extra);
            menuGenericRepository.Update(menu);
            ...
            orderList.CustomerMenus=order.Menus.ToList();
            orderList.CustomerExtras=order.Extras.ToList();
            //orderList.AdminExtras.Remove(extra);
