...
namespace Diyet
{
    public partial class frmAddNutrient : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                dataGridView1.Rows.Add(cbMeal.Text, cbCategory.Text, nutrientServices.GetByNutrientId((int)listBoxFoods.SelectedValue).NutrientName, textBox1.Text, nutrientServices.GetCalorieByNutrientID((int)listBoxFoods.SelectedValue));
