...
namespace Diet_BL.Services
{
    public class MainTableServices
    {
        ...
        public bool Delete(MainTable mainTable)
        {
            return mainTableRepository.Delete(mainTable);
        }
        public bool Update(MainTable mainTable)
        {
            return mainTableRepository.Update(mainTable);
        }
